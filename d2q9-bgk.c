...
*/
int timestep(const t_param params, t_speed* cells, t_speed* tmp_cells, int* obstacles, int indices[], int size);
int accelerate_flow(const t_param params, t_speed* cells, int* obstacles);
int propagate(const t_param params, t_speed* cells, t_speed* tmp_cells);
int rebound(const t_param params, t_speed* cells, t_speed* tmp_cells, int* obstacles);
int collision(const t_param params, t_speed* cells, t_speed* tmp_cells, int obstacles[],int size);
...
int timestep(const t_param params, t_speed* cells, t_speed* tmp_cells, int* obstacles, int indices[], size)
{
  accelerate_flow(params, cells, obstacles);
  propagate(params, cells, tmp_cells);
  rebound(params, cells, tmp_cells, indices[],size);
...
int collision(const t_param params, t_speed* cells, t_speed* tmp_cells, int obstacles[], size)
{
